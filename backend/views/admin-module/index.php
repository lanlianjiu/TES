                                ...
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="data_table_info">
                                    ...
                                    <?php
                                        ...
                                        foreach ($models as $model) {
                                            ...
                                            echo '      <a id="view_btn" class="btn btn-primary btn-xs" href="'.Url::toRoute(['admin-menu/index', 'mid'=>$model->id]) .'"> <i class="glyphicon glyphicon-zoom-in icon-white"></i> 二级菜单</a>';
                                            //                 echo '      <a id="view_btn" onclick="viewAction(' . $model->id . ')" class="btn btn-primary btn-xs" href="#"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>菜单管理</a>';
